...
/*
** special spheres materials
*/
t_vect			sphere_mirror(t_ray r, t_scene scene, int a_def,
								int nb_rebound);
t_vect			sphere_trans(t_scene scene, t_ray r, t_vect int_pix,
								int nb_rebound);
...
void			create_res_cam(t_scene *sc, char *data, char *data_type,
								int *i);
...
void			create_square_triangle(t_scene *sc, char *data, char *data_type,
										int *i);
